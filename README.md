CoinMarketInfo - это приложение для для просмотра информации о криптовалютах, добавлению криптовалют в избранное и создание собственных портфелей, также реализована регистрация пользователя.
