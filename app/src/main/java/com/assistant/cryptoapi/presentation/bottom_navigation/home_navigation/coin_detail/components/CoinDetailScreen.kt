...
import com.assistant.cryptoapi.presentation.bottom_navigation.home_navigation.coin_detail.components.officia_links.GitHub
...
import com.assistant.cryptoapi.presentation.bottom_navigation.home_navigation.coin_detail.components.officia_links.WhitePaper
...
import com.assistant.cryptoapi.presentation.bottom_navigation.home_navigation.coin_detail.components.social_networks.Facebook
import com.assistant.cryptoapi.presentation.bottom_navigation.home_navigation.coin_detail.components.social_networks.Reddit
            ...
            coinDetail.coin?.let { coinDetail ->
                ...
                Row(
                    ...
                    Row(
                        ...
                        IconButton(
                            onClick = { coinDetailviewModel.changeStar() },
                            modifier = Modifier.size((width * 0.07).dp)
                        ) {
                            Icon(
